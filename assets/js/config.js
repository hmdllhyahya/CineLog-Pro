...
window.CINELOG_CONFIG = {
  ...
  SUPABASE_ANON_KEY: 'sb_publishable_We-75r2r46uvbvOux3FTWw_ENbpdI5h',

  // TMDB (The Movie Database) – get from: https://www.themoviedb.org/settings/api
  // Used for movie search in the Log modal. App works without it (local-only mode).
  TMDB_KEY: '849b72ab31fb69f120ef8c5df5c5f7d0'
};
